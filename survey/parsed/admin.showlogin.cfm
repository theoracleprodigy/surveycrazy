...
<cftry>
<!--- admin.showlogin: <fusebox:plugin name="SimpleSecurity">                     --->
...
<!--- admin.showlogin: <fusebox:set name="myFusebox.thisFuseaction" value="showlogin"> --->
<cfset myFusebox.thisFuseaction = "showlogin">
<!--- admin.showlogin: <fusebox:errorhandler name="exceptionHandler">             --->
...
<!--- admin.showlogin: <fusebox:errorhandler name="SecurityException">            --->
