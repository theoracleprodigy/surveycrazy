...
<!--- admin.saveQuestion: <fusebox:plugin name="SimpleSecurity">                  --->
...
<!--- v.header: <fusebox:set name="myFusebox.thisCircuit" value="v">              --->
<cfset myFusebox.thisCircuit = "v">
<!--- admin.saveQuestion: <fusebox:set name="myFusebox.thisCircuit" value="admin"> --->
<cfset myFusebox.thisCircuit = "admin">
<!--- admin.saveQuestion: <fusebox:set name="myFusebox.thisFuseaction" value="saveQuestion"> --->
<cfset myFusebox.thisFuseaction = "saveQuestion">
<!--- admin.saveQuestion: <fusebox:set overwrite="false" name="attributes.survey_question_id" value=""> --->
<cfif NOT IsDefined("attributes.survey_question_id")>
	<cfset attributes.survey_question_id = "">
</cfif>
<!--- admin.saveQuestion: <fusebox:invoke methodcall="saveQuestion(   survey_id=attributes.survey_id,   survey_question_id=attributes.survey_question_id,   survey_question_order=attributes.survey_question_order,   survey_type_id=attributes.survey_type_id,   survey_allow_text=attributes.survey_allow_text,   survey_question=attributes.survey_question,   survey_text_question=attributes.survey_text_question)" object="application.surveymanager"> --->
<cfset application.surveymanager.saveQuestion(   survey_id=attributes.survey_id,   survey_question_id=attributes.survey_question_id,   survey_question_order=attributes.survey_question_order,   survey_type_id=attributes.survey_type_id,   survey_allow_text=attributes.survey_allow_text,   survey_question=attributes.survey_question,   survey_text_question=attributes.survey_text_question) />
