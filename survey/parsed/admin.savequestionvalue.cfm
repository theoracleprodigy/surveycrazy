...
<!--- admin.saveQuestionValue: <fusebox:plugin name="SimpleSecurity">             --->
...
<!--- v.header: <fusebox:set name="xfa.logout" value="c.logout">                  --->
<cfset xfa.logout = "c.logout">
...
<!--- v.header: <fusebox:set name="myFusebox.thisCircuit" value="v">              --->
<cfset myFusebox.thisCircuit = "v">
<!--- admin.saveQuestionValue: <fusebox:set name="myFusebox.thisCircuit" value="admin"> --->
<cfset myFusebox.thisCircuit = "admin">
<!--- admin.saveQuestionValue: <fusebox:set name="myFusebox.thisFuseaction" value="saveQuestionValue"> --->
<cfset myFusebox.thisFuseaction = "saveQuestionValue">
<!--- admin.saveQuestionValue: <fusebox:set overwrite="false" name="attributes.survey_option_values_id" value=""> --->
<cfif NOT IsDefined("attributes.survey_option_values_id")>
	<cfset attributes.survey_option_values_id = "">
</cfif>
<!--- admin.saveQuestionValue: <fusebox:invoke methodcall="saveQuestionValue(    survey_option_values_id=attributes.survey_option_values_id,    survey_question_id=attributes.survey_question_id,    suvery_values_disp=attributes.suvery_values_disp,    survey_values_value=attributes.survey_values_value,    survey_option_order=attributes.survey_option_order)" object="application.surveymanager"> --->
<cfset application.surveymanager.saveQuestionValue(    survey_option_values_id=attributes.survey_option_values_id,    survey_question_id=attributes.survey_question_id,    suvery_values_disp=attributes.suvery_values_disp,    survey_values_value=attributes.survey_values_value,    survey_option_order=attributes.survey_option_order) />
