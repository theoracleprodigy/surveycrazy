...
<!--- admin.deleteSurvey: <fusebox:plugin name="SimpleSecurity">                  --->
...
<!--- v.header: <fusebox:set name="myFusebox.thisCircuit" value="v">              --->
<cfset myFusebox.thisCircuit = "v">
<!--- admin.deleteSurvey: <fusebox:set name="myFusebox.thisCircuit" value="admin"> --->
<cfset myFusebox.thisCircuit = "admin">
<!--- admin.deleteSurvey: <fusebox:set name="myFusebox.thisFuseaction" value="deleteSurvey"> --->
<cfset myFusebox.thisFuseaction = "deleteSurvey">
<!--- admin.deleteSurvey: <fusebox:invoke methodcall="deleteSurvey(attributes.survey_id)" object="application.surveymanager"> --->
<cfset application.surveymanager.deleteSurvey(attributes.survey_id) />
